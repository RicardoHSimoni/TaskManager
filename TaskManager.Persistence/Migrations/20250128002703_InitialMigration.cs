        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurringLaborId = table.Column<int>(type: "INTEGER", nullable: true),
                    Recurence = table.Column<int>(type: "INTEGER", nullable: true),
                    NextExecution = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SimpleLaborId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
